...
- integrating with LightBurn’s Print & Cut workflow,
...
- Integration with LightBurn via hotkeys  
...
5. User confirms point in LightBurn.  
6. Repeat for second marker.  
7. LightBurn computes alignment and proceeds with cutting.  
